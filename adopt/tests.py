...
class SearchResultsViewTests(TestCase):
	...
	def test_sterilized(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?sterilized=true")
	...
	def test_house_trained(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?house_trained=true")
	...
	def test_house_trained_and_sterilized(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?house_trained=true&sterilized=true")
	...
	def test_male_only(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?sex=Male")
	...
	def test_young_only(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?age=Young")
	...
	def test_male_or_female(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?sex=Male&sex=Female")
	...
	def test_young_or_senior(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?age=Young&age=Senior")
	...
	def test_kitten_or_adult_or_senior(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?age=Kitten&age=Adult&age=Senior")
	...
	def test_male_kitten_and_adult(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?age=Kitten&age=Adult&sex=Male")
	...
	def test_female_young_and_senior(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?age=Young&age=Senior&sex=Female")
	...
	def test_only_white(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?color=White")
	...
	def test_brown_and_black(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?color=Black&color=Brown")
	...
	def test_not_white_female(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?" + color_params + "&sex=Female")
	...
	def test_all_colors_allowed(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?" + color_params)
	...
	def test_not_fulfilled_query(self):
		...
		response = self.client.get(reverse("adopt:search_results") + "?color=Orange&sex=Female")
